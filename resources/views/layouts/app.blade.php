        ...
        <div class="flex-1 p-4 ml-14">
            <nav class="flex items-center justify-between bg-white p-4 shadow-lg rounded-lg relative z-10">
                <div class="ml-auto relative flex">
                    ...
                    <button id="userDropdown" onclick="toggleDropdown()" class="text-gray-700 mr-5">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-8 border-2 rounded-full">
                            <path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clip-rule="evenodd" />
                        </svg>
                    </button>

                    <!-- User Profile Dropdown -->
                    <div id="dropdownMenu" class="absolute right-0 mt-14 w-80 bg-white rounded-lg shadow-lg transition-all duration-300 hidden">
                        <div class="py-2 px-4">
                            <h5 class="text-xl mt-2 ml-2 font-semibold">User Profile</h5>
                        </div>
                        <div class="flex align-items-center pt-5 mx-5 border-bottom">
                            <img src="https://pkl.hummatech.com/user.webp" class="rounded-3xl" width="80" height="80" alt="">
                            <div class="ms-3">
                                <h5 class="mb-1 font-medium"><span class="uppercase">{{ Auth::user()->name }}</span></h5>
            ...
            <script>
                ...
                document.addEventListener("click", function (event) {
                    ...
                    if (!dropdown.classList.contains("hidden") && !dropdown.contains(event.target) && !userDropdownButton.contains(event.target)) {
