        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            @forelse($subjects as $subject)
                <a href="{{ route('Materi', ['materi_id' => $subject->id]) }}"
                    ...
                    style="background-image: url('image/siswa/cardmapel.svg'); background-size: cover; background-position: center; border-radius: 15px; padding: 20px; text-decoration: none; transition: all 0.3s ease;
