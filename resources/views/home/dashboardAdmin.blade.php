                ...
                <div class="grid gap-10 grid-cols-2">
                    <div class="h-40 p-5 bg-white shadow-sm rounded-lg flex items-center">
                        ...
                        <div class="text-gray-700">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class=" size-24 ml-2 mr-8">
                                <path fill="#99CCFF"
                    ...
                    <div class="h-40 p-5 bg-white shadow-sm rounded-lg flex items-center">
                        <!-- SVG Icon -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-24  mr-4" viewBox="0 0 72 72">
                                <path fill="#99CCFF"
                                ...
                                <path fill="none" stroke="#99CCFF" stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <path fill="#99CCFF"  d="M21.313 21a1 1 0 0 1-1-1v-8.12a1 1 0 1 1 2 0V20a1 1 0 0 1-1 1" />
                                <path fill="#99CCFF"
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="text-4xl font-bold text-sky-500 ">3600</div>
                        </div>
                    </div>
                </div>
            </div>
