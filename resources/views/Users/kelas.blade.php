    ...
    <section class="h-screen">
        <div class="container mx-auto p-10">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div class="card h-350px relative flex flex-col justify-between text-white"
                    style="background-image: url('image/Frame 2056.svg'); background-size: cover; background-position: center; border-radius: 15px; text-decoration: none;">

                    <!-- Judul Matematika besar dan bold, berada di tengah kiri -->
                    <div class="absolute top-1/2 transform -translate-y-1/2 text-3xl font-bold">
                        Kelas 10
                    </div>
                </div>

                <div class="card h-200px relative shadow-lg flex flex-col justify-between text-white"
