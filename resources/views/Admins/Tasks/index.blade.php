                         ...
                         <tbody class="">
                             ...
                             @foreach ($tasks as $task)
                                 <tr class="border border-gray-300">
                                     <td class="py-3 px-6">{{ $loop->iteration + $offset }}</td>
                     ...
                     <div class="bg-white rounded-lg w-[40%] h-auto pt-6 pb-2 pl-6">
                         ...
                         <form action="{{ route('tasks.update', $task->id) }}" method="POST"
                             ...
                             <div class="grid grid-cols-2 gap-4">
                                 ...
                                 <div class="mb-4 mr-6">
                                     <label for="title_task" class="block text-gray-700 font-bold mb-2">Judul
                                         Tugas</label>
                                     <input type="text" id="title_task" name="title_task"
                             ...
                             <div class="mb-4 mr-6">
                                 <label for="description_task"
                                     class="block text-gray-700 font-bold mb-2">Deskripsi</label>
