            ...
            <div class="container mx-auto p-4">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a class="group relative inline-block text-xs font-medium text-blue-500 focus:outline-none focus:ring active:text-indigo-500"
                        ...
                        <span class="relative block border border-current bg-white px-3 py-2 rounded-md">Tambah Kelas
                            -></span>
                    </a>
                </div>
            </div>
                                ...
                                <div class="p-5">
                                    ...
                                    <form action="{{ route('classes.update', $class->id) }}" method="POST" class="mt-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input id="name_class" type="text" class="w-full px-4 py-2 border rounded"
                                                name="name_class" value="{{ $class->name_class }}">
                                        </div>
            ...
            <div class="bg-white rounded-lg overflow-hidden w-full max-w-lg mx-4">
                <div class="p-5">
                    ...
                    <form action="{{ route('classes.store') }}" method="POST" class="mt-4">
                        ...
                        <button type="submit" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded">Tambah
                            Kelas</button>
