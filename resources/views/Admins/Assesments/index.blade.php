    ...
    <div class="container mx-auto p-4">
        <div class="flex items-center justify-between mb-4">
            ...
            <a class="group relative inline-block text-xs font-medium text-blue-500 focus:outline-none focus:ring active:text-indigo-500"
                ...
                <span class="relative block border border-current bg-white px-3 py-2 rounded-md">Tambah Penilaian -></span>
            </a>
        </div>
    </div>
                ...
                @foreach ($assessments as $index => $assessment)
                    <tr>
                        ...
                        <td class="border px-4 py-2 ">
                            ...
                            <button type="button"
                            class="text-yellow-500 rounded-sm"
                            ...
                            <form action="{{ route('assesments.destroy', $assessment->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="text-red-500 rounded-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus assessment ini?')">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
        ...
        <div class="bg-white rounded-lg shadow-lg w-full p-6">
            ...
            <form action="{{ route('assesments.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <button type="submit" class="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded">Tambah Penilaian</button>
