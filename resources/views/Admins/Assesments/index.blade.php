...
<div class="container mx-auto p-4">
    <div class="container mx-auto pt-2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2 ">
                                ...
                                <!-- Delete form -->
                                <form action="{{ route('assesments.destroy', $assessment->id) }}"
                    ...
                    <form action="{{ route('assesments.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="task_id" id="task_id" class="w-full px-3 py-2 border rounded">
                                <option value="" disabled {{ old('task_id') ? '' : 'selected' }}>Pilih Tugas</option>
        ...
        <div id="editAssessmentModal_{{ $assessment->id }}" class="assessmentModal hidden fixed inset-0 z-50 overflow-y-auto"
            style="display: none;">
            <div class="flex items-center justify-center min-h-screen px-4">
