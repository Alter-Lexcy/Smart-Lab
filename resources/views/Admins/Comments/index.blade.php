...
@section('content')
    <div class="container mx-auto px-4 mt-5">
        ...
        <button type="button" class="bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-r hover:from-cyan-600 hover:to-blue-600 text-white font-bold py-2 px-4 rounded mb-4" onclick="toggleModal('addCommentModal')">
            Tambah Komentar
        </button>
