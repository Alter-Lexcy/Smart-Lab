            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editTeacherModal-{{ $teacher->id }}">
                            Ubah
                        </button>
                        <!-- Tombol Hapus -->
                            ...
                            <div class="modal-body">
                                <form action="{{ route('teachers.update', $teacher->id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name_teacher" name="name_teacher" value="{{ $teacher->name_teacher }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="NIP" class="form-label">NIP</label>
                                        <input type="number" class="form-control" id="NIP" name="NIP" value="{{ $teacher->NIP }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="email_teacher" class="form-label">Email Guru</label>
                                        <input type="email" class="form-control" id="email_teacher" name="email_teacher" value="{{ $teacher->email_teacher }}">
                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('teachers.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="email_teacher" class="form-label">Email Guru</label>
                            <input type="email" class="form-control" id="email_teacher" name="email_teacher" required>
                        </div>
