    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white text-center border border-gray-300 rounded-lg">
            ...
            <tbody>
                ...
                <div id="assignModal-{{$teacher->id}}" class="fixed inset-0 bg-black bg-opacity-50  items-center justify-center "
        style="display: none">
            ...
            <div class="p-5">
                ...
                <form action="{{ route('assignTeacher', $teacher->id) }}" method="POST" class="mt-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="classes_id" id="classes_id" class="w-full px-3 py-2 border rounded">
                            <option value="" disabled selected>Pilih Kelas</option>
                            @foreach ($classes as $classes)
                            <option value="{{ $classes->id }}" {{ request('classes_id') == $classes->id ? 'selected' : '' }}>
                                {{ $classes->name_class }}
                            </option>
                            @endforeach
                        </select>
