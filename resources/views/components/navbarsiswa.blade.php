            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-3 ms-md-6" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-35px"
                        data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                        data-kt-menu-placement="bottom-end">
                        <img src="https://class.hummatech.com/app-assets/media/svg/avatars/blank.svg"
                            alt="image" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"
                                        ...
                                        <span class="__cf_email__"
                                            data-cfemail="400132242925322d24282e7075717000272d21292c6e232f2d">[email&#160;protected]</span></a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="https://class.hummatech.com/logout" class="menu-link px-5"
                                onclick="event.preventDefault();
                                        document.getElementById('logout-form').submit();">
                                Keluar
                            </a>
                            <form id="logout-form" action="https://class.hummatech.com/logout" method="POST"
                                class="d-none">
                                <input type="hidden" name="_token"
                                    value="8IMVNabevkMVEFpvO472s41XBcvpCVja5sJxIXQO">
                            </form>
                        </div>
                        <!--end::Menu item-->
                    </div>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item py-1">
                        ...
                        <a href="/dashboard"
                            ...
                            <span class="pt-2 fs-9 fs-lg-7 fw-bold">Beranda</span>
                        </a>
                    ...
                    <li class="nav-item py-1">
                        <!--begin::Navbar link-->
                        <a href="/mapel" class="nav-link py-4 px-1 btn">
                            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path fill-rule="evenodd"
                            ...
                            <span class="pt-2 fs-9 fs-lg-7 fw-bold">Mapel</span>
                        </a>
                        <!--end::Navbar link-->
                    </li>
                    ...
                    <li class="nav-item py-1">
                        <!--begin::Navbar link-->
                        <a href="/tugas" class="nav-link py-4 px-1 btn ">
                            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                viewBox="0 0 24 24">
                                <path fill-rule="evenodd"
